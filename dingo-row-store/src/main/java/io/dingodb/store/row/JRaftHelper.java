...
public final class JRaftHelper {
    ...
    public static String getRaftDataPath(final String baseDataPath, final String storeId, int endPointPort) {
        String childPath = "raft_store_" + storeId + "_" + endPointPort;
    ...
    public static String getDBDataPath(final String baseDataPath, final String storeId, int endPointPort) {
        String childPath = "db_store_" + storeId + "_" + endPointPort;
        return Paths.get(baseDataPath, childPath).toString();
    }
}
