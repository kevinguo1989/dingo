...
import io.dingodb.api.CoordinatorServerApi;
import io.dingodb.api.ExecutorServerApi;
import io.dingodb.api.TableCoordinatorServerApi;
...
public class DingoDmlExecutor {
    ...
    public void executeUpdate(String tableName, Object[] record) throws Exception {
        ...
        Map<String, String> changedIndexExecutorAddr = tableCoordinatorServerApi.getChangedIndexExecutorAddr(tableName, changedIndexName);
