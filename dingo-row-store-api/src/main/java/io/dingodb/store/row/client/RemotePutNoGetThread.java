...
public class RemotePutNoGetThread implements Callable<Long> {

    private static final Logger LOG = LoggerFactory.getLogger(RemotePutNoGetThread.class);
    ...
    public RemotePutNoGetThread(DingoRowStoreRpcService dingoRowStoreRpcService,
    ...
    public Long call() {
        ...
        try {
            ...
            for (; times < this.times; times++) {
                ...
                regionOp.internalPut(regions, kvEntries, 3, null, dingoRowStoreRpcService);
                ...
                LOG.info("Put time " + times + " Gap = " + gap + "  TotalGap = " + totalGap);
            }
            return totalGap;
        } catch (Exception e) {
            LOG.error("Put time " + times + " " + e.toString());
        }
        return 0L;
    }
}
